...
<div class="container-fluid pt-4 px-4">
  <div class="row g-4">
    ...
    <form action="{{route('admin.homeeditpostl')}}" method="post" enctype="multipart/form-data">
    @csrf
        <div class="bg-secondary rounded h-100 p-4">
            <h6 class="mb-4">Home Page Edit</h6>
            ...
            <img src="{{asset('temp/images/')}}" alt="#" width="100px" />
            <div class="bg-secondary rounded">
                <div class="m-n2">
                    <button type="submit" class="btn btn-outline-success m-2">Edit Post</button>
                </div>
            </div>
        </div>
      </form>
