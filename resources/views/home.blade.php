               ...
               <div class="carousel-item active">
                  <div class="container">
                     <div class="banner_taital_main">
                        <div class="row">
                           <div class="col-md-6">
                              <h1 class="banner_taital">{{$home->sliderTitle}}</h1>
                              <p class="banner_text">{{$home->sliderText}}</p>
                              <div class="btn_main">
                           ...
                           <div class="col-md-6">
                              <div class="image_1"><img src="{{asset('temp/images/'.$home->sliderImg)}}" class="img-height"></div>
                           </div>
                        </div>
                     </div>
                  </div>
         ...
         <div class="container">
            ...
            <div class="news_section_2">
               <div class="row">
                  ...
                  <div class="col-md-6">
                     <img src="{{asset('temp/images/img-6.png')}}" class="image_6" style="width:100%">
                  ...
                  <div class="container">
                     ...
                     <div class="client_section_2">
                        <div class="client_left">
                           <div><img src="{{asset('temp/images/client-img.png')}}" class="client_img"></div>
                        </div>
